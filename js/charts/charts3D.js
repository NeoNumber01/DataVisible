...
const Charts3D = {
    ...
    createPseudo3DControls(container, chart, options, chartType, data, renderFunc) {
        ...
        const onMouseMove = (e) => {
            ...
            // 计算新的透视角度 - 反转方向：鼠标向右时角度减少，向左时角度增加
            depthAngleX = Math.max(0, Math.min(3, startAngleX - deltaX * sensitivityX));
            depthAngleY = Math.max(-2, Math.min(0, startAngleY - deltaY * sensitivityY));
